            ...
            <div className='header d-flex-sb Bar-top'>
                ...
                <div className='c-header'>
                    <ul className="mega_menu">
                        ...
                        <li><span>Deals {'&'} Promotions</span><span className="iconify" data-icon="dashicons:arrow-down"></span></li>
                        ...
                        <div className='dropdownn'>
                            <li><span>Category</span><span className="iconify" data-icon="dashicons:arrow-down"></span></li>
                            <div className='dropdownn-content-wrapper'>
                        ...
                        <div className='dropdownn'>
                            <li><span>Age</span><span className="iconify" data-icon="dashicons:arrow-down"></span></li>
                            <div className='dropdownn-content-wrapper'>
                ...
                <div className='r-header'>
                    <ul>
                        <li><span className="iconify" data-icon="akar-icons:truck" style={{color:"var(--color-pink)"}}></span><span>Track Order</span></li>
                        <li><span className="iconify" data-icon="bx:user" style={{color:"var(--color-blue)"}}></span><span>Login</span></li>
                        <li><span className="iconify" data-icon="ant-design:heart-outlined" style={{color:"var(--color-red)"}}></span><span>Wishlist</span></li>
